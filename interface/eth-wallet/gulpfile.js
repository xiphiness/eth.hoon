...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('../../arvo/app/eth-wallet/css'));
});
...
gulp.task('js-imports', function(cb) {
  ...
  .pipe(gulp.dest('../../arvo/app/eth-wallet/js/'))
  .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('../../arvo/app/eth-wallet/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('../../arvo/app/eth-wallet/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('../../arvo/app/eth-wallet/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('../../arvo/app/eth-wallet/js/'));
});

gulp.task('rename-index-min', function() {
  return gulp.src('../../arvo/app/eth-wallet/js/index-min.js')
    .pipe(rename('index.js'))
    .pipe(gulp.dest('../../arvo/app/eth-wallet/js/'))
});

gulp.task('rename-tile-min', function() {
  return gulp.src('../../arvo/app/eth-wallet/js/tile-min.js')
    .pipe(rename('tile.js'))
    .pipe(gulp.dest('../../arvo/app/eth-wallet/js/'))});

gulp.task('clean-min', function() {
  return del(['../../arvo/app/eth-wallet/js/index-min.js', '../../arvo/app/eth-wallet/js/tile-min.js'], {force: true})
});
